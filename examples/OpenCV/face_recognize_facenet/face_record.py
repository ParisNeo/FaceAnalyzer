"""=============
    ...
    Description :
        ...
        Press s to take few face shots and then give the name of the person.
        Next, use face_recognize to recognize the face you have 
    ...
    if wk & 0xFF == 115: # If s is pressed then take a snapshot
        ...
        for i in tqdm(range(10)):
            ...
            if fa.nb_faces>0:
                ...
                vertices = face.get_face_outer_vertices()
                image = face.getFaceBox(image, vertices)
                embedding = facenet.predict(cv2.resize(image,(160,160))[None,...])
